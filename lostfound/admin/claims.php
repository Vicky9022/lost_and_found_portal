...
<head>
    ...
    <title>Lost and Found System-All Claim Request</title>
    <!-- CSS -->
...
<div class="page has-sidebar-left bg-light height-full">
    ...
    <div class="container-fluid my-3">
        ...
        <div class="container-fluid text-white">
            <div class="row">
                <div class="col">
                    <h3 class="my-3">
                     <?php echo $_GET['uname'];?>'s Claim Request
                    </h3>
                </div>
            </div>
        </div>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <img src="../user/images/<?php echo htmlspecialchars($row['Image1']); ?>" width="100">
            </td>
