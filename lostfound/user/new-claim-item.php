...
<head>
    ...
    <title>Lost and Found System-New Request</title>
    <!-- CSS -->
...
<div class="page has-sidebar-left bg-light height-full">
    ...
    <tbody>
        ...
        WHERE 
            tblfounditem.Userid = '$uid' && tblclaim.Status='Claim Request'
        ";
        ...
        <tr>
            ...
            <td><?php echo $row['cstatus'] ? htmlspecialchars($row['cstatus']) : "Claim Request Not Received"; ?></td>
