...
<head>
    ...
    <title>Lost and Found System-Rejected Request</title>
    <!-- CSS -->
...
<div class="page has-sidebar-left bg-light height-full">
    ...
    <tbody>
        ...
        WHERE tblfounditem.Userid = '$uid' and tblfounditem.Status='Rejected'";
        ...
        <tr>
            ...
            <td><img src="images/<?php echo htmlspecialchars($row['Image1']); ?>" width="100"></td>
